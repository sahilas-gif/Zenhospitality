        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center gap-3">
            <div className="w-9 h-9 bg-emerald-500 rounded-lg flex items-center justify-center shadow-lg shadow-emerald-500/20">
              <span className="text-white font-bold text-sm tracking-tighter">ZW</span>
            </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative" ref={dropdownRef}>
              <button onClick={() => setServicesOpen((o) => !o)} className={`flex items-center text-sm hover:text-emerald-400 transition-colors uppercase tracking-wider ${isServicesActive ? 'text-emerald-500' : 'text-gray-300'}`}>
            ...
            <Link to="/domestic-tours" className={linkClass('/domestic-tours')}>Domestic Tours</Link>
